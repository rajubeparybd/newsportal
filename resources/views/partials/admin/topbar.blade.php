<div class="navbar-custom">
                ...
                <div class="slimscroll noti-scroll">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item active">
                        <div class="notify-icon">
                            <img src="{{asset('backend/images/users/user-1.jpg')}}" class="img-fluid rounded-circle"
                                 alt=""/>
                        </div>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon">
                            <img src="{{asset('backend/images/users/user-4.jpg')}}" class="img-fluid rounded-circle"
                                 alt=""/>
                        </div>
    ...
    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
        <li>
            <button class="button-menu-mobile  waves-effect"> <!-- disable-btn -->
                <i class="fe-menu"></i>
            </button>
        </li>
        <li>
