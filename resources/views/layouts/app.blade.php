                        ...
                        <div class="row gy-5">
                            <div class="col-sm-6">
                                ...
                                <div class="post">
                                    ...
                                    <h5 class="post-title mb-3 mt-3"><a href="{{asset('blog-single.html')}}">15 Unheard Ways To Achieve Greater Walker</a></h5>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="post post-list-sm square">
                                    ...
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="{{asset('blog-single.html')}}">3 Easy Ways To Make Your iPhone Faster</a></h6>
                                ...
                                <div class="post post-list-sm square">
                                    ...
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="{{asset('blog-single.html')}}">An Incredibly Easy Method That Works For All</a></h6>
                                        <ul class="meta list-inline mt-1 mb-0">
                                            <li class="list-inline-item">29 March 2021</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="post post-list-sm square">
                                    ...
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="{{asset('blog-single.html')}}">10 Ways To Immediately Start Selling Furniture</a></h6>
                                        <ul class="meta list-inline mt-1 mb-0">
                                            <li class="list-inline-item">29 March 2021</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="post post-list-sm square">
                                    ...
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="{{asset('blog-single.html')}}">15 Unheard Ways To Achieve Greater Walker</a></h6>
                                        <ul class="meta list-inline mt-1 mb-0">
                                            <li class="list-inline-item">29 March 2021</li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row gy-5">
                            <div class="col-sm-6">
                                ...
                                <div class="post">
                                    ...
                                    <h5 class="post-title mb-3 mt-3"><a href="{{asset('blog-single.html')}}">Facts About Business That Will Help You Success</a></h5>
                                    <p class="excerpt mb-0">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy</p>
                                </div>
                                <!-- post -->
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="post">
                                    ...
                                    <h5 class="post-title mb-3 mt-3"><a href="{{asset('blog-single.html')}}">5 Easy Ways You Can Turn Future Into Success</a></h5>
                                    <p class="excerpt mb-0">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy</p>
                                </div>
                                <!-- post -->
                                <div class="post post-list-sm square before-seperator">
                                    ...
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="{{asset('blog-single.html')}}">Here Are 8 Ways To Success Faster</a></h6>
                                        <ul class="meta list-inline mt-1 mb-0">
                                            <li class="list-inline-item">29 March 2021</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="post post-list-sm square before-seperator">
                                    ...
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="{{asset('blog-single.html')}}">Master The Art Of Nature With These 7 Tips</a></h6>
                                        <ul class="meta list-inline mt-1 mb-0">
                                            <li class="list-inline-item">29 March 2021</li>
                                        </ul>
                                    </div>
                    ...
                    <div class="row post-carousel-twoCol post-carousel">
                        ...
                        <div class="post post-over-content col-md-6">
                            <div class="details clearfix">
                                ...
                                <h4 class="post-title"><a href="{{asset('blog-single.html')}}">Want To Have A More Appealing Tattoo?</a></h4>
                        ...
                        <div class="post post-over-content col-md-6">
                            <div class="details clearfix">
                                <a href="{{asset('category.html')}}" class="category-badge">Inspiration</a>
                                <h4 class="post-title"><a href="{{asset('blog-single.html')}}">Feel Like A Pro With The Help Of These 7 Tips</a></h4>
                                <ul class="meta list-inline mb-0">
                                    <li class="list-inline-item"><a href="#">Katen Doe</a></li>
                                    <li class="list-inline-item">29 March 2021</li>
                                </ul>
                        ...
                        <div class="post post-over-content col-md-6">
                            <div class="details clearfix">
                                <a href="{{asset('category.html')}}" class="category-badge">Inspiration</a>
                                <h4 class="post-title"><a href="{{asset('blog-single.html')}}">Your Light Is About To Stop Being Relevant</a></h4>
                                <ul class="meta list-inline mb-0">
                                    <li class="list-inline-item"><a href="#">Katen Doe</a></li>
                                    <li class="list-inline-item">29 March 2021</li>
                                </ul>
                            ...
                            <div class="col-md-12 col-sm-6">
                                ...
                                <div class="post post-list clearfix">
                                    ...
                                    <div class="details">
                                        ...
                                        <h5 class="post-title"><a href="{{asset('blog-single.html')}}">The Next 60 Things To Immediately Do About Building</a></h5>
                                        ...
                                        <div class="post-bottom clearfix d-flex align-items-center">
                                            ...
                                            <div class="more-button float-end">
                                                <a href="{{asset('blog-single.html')}}"><span class="icon-options"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-6">
                                ...
                                <div class="post post-list clearfix">
                                    ...
                                    <div class="details">
                                        ...
                                        <h5 class="post-title"><a href="{{asset('blog-single.html')}}">Master The Art Of Nature With These 7 Tips</a></h5>
                                        <p class="excerpt mb-0">A wonderful serenity has taken possession of my entire soul, like these sweet mornings</p>
                                        <div class="post-bottom clearfix d-flex align-items-center">
                                            <div class="social-share me-auto">
                                                <button class="toggle-button icon-share"></button>
                            ...
                            <div class="col-md-12 col-sm-6">
                                ...
                                <div class="post post-list clearfix">
                                    ...
                                    <div class="details">
                                        ...
                                        <h5 class="post-title"><a href="{{asset('blog-single.html')}}">Facts About Business That Will Help You Success</a></h5>
                                        <p class="excerpt mb-0">A wonderful serenity has taken possession of my entire soul, like these sweet mornings</p>
                                        <div class="post-bottom clearfix d-flex align-items-center">
                                            <div class="social-share me-auto">
                                                <button class="toggle-button icon-share"></button>
                            ...
                            <div class="col-md-12 col-sm-6">
                                ...
                                <div class="post post-list clearfix">
                                    ...
                                    <div class="details">
                                        ...
                                        <h5 class="post-title"><a href="{{asset('blog-single.html')}}">Your Light Is About To Stop Being Relevant</a></h5>
                                        <p class="excerpt mb-0">A wonderful serenity has taken possession of my entire soul, like these sweet mornings</p>
                                        <div class="post-bottom clearfix d-flex align-items-center">
                                            <div class="social-share me-auto">
                                                <button class="toggle-button icon-share"></button>
                            ...
                            <div class="widget-content">
                                <div class="post-carousel-widget">
                                    ...
                                    <div class="post post-carousel">
                                        <div class="thumb rounded">
                                            <a href="{{asset('category.html')}}" class="category-badge position-absolute">How to</a>
                                            <a href="{{asset('blog-single.html')}}">
                                                <div class="inner">
                                        ...
                                        <h5 class="post-title mb-0 mt-4"><a href="{{asset('blog-single.html')}}">5 Easy Ways You Can Turn Future Into Success</a></h5>
                                    ...
                                    <div class="post post-carousel">
                                        <div class="thumb rounded">
                                            <a href="{{asset('category.html')}}" class="category-badge position-absolute">Trending</a>
                                            <a href="{{asset('blog-single.html')}}">
                                                <div class="inner">
                                        ...
                                        <h5 class="post-title mb-0 mt-4"><a href="{{asset('blog-single.html')}}">Master The Art Of Nature With These 7 Tips</a></h5>
                                        <ul class="meta list-inline mt-2 mb-0">
                                            <li class="list-inline-item"><a href="#">Katen Doe</a></li>
                                            <li class="list-inline-item">29 March 2021</li>
                                        </ul>
